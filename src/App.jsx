  ...
  if (!hasAccess) {
    return (
      <div style={{
        ...
        padding: 24, textAlign: 'center', background: '#f8f9fb',
      }}>
        <div>
          <div style={{
            display: 'inline-block', background: '#3b6cf5', color: '#fff',
            fontWeight: 700, fontSize: 13, padding: '6px 12px', borderRadius: 8,
            marginBottom: 16,
          }}>CR</div>
          <h1 style={{ fontSize: 24, marginBottom: 8, color: '#0c1421' }}>CIIReady R01</h1>
          <p style={{ color: '#5e6878', marginBottom: 24, maxWidth: 400, lineHeight: 1.6 }}>
            Access this app via the link in your purchase confirmation email.
          </p>
          <a
            href="https://ciiready.co.uk"
            style={{
              background: '#3b6cf5', color: '#fff', padding: '12px 28px',
